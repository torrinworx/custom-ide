...
import { Theme, Icons, Button, TextModifiers, Select, PopupContext } from 'destamatic-ui';
	...
	<Icons value={theme.icons}>
		<PopupContext>
			<TextModifiers value={Observer.immutable([
				...
				<TextField style={{ marginTop: 500, background: 'black', color: 'white' }} value={value} />
			</TextModifiers>

			<Select options={['javascript', 'python', 'markdown']} value={language} />

			<TextModifiers value={modifiers} >
				<TextField style={{ background: 'black', color: 'white' }} value={value2} />
			</TextModifiers>
		</PopupContext>
	</Icons>
</Theme>);
